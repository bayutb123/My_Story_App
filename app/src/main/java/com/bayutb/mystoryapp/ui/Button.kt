...
class Button : AppCompatButton {
    ...
    private fun init() {
        ...
        enabled = ContextCompat.getDrawable(context, R.drawable.ui_button) as Drawable
        disabled = ContextCompat.getDrawable(context, R.drawable.ui_button_disabled) as Drawable
    }
}